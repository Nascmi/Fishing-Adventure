...
export const achievements = [
  ...
  { id: 'fine-specimen', name: 'A Fine Specimen', description: 'Catch a Trophy or Amazing specimen.', flavor: 'Some catches deserve a longer look.', test: (s) => ['trophy', 'amazing'].includes(s.stats.largestFish?.sizeTier) || s.inventory.some((item) => ['trophy', 'amazing'].includes(item.sizeTier)) },
  ...
  { id: 'one-for-stories', name: 'One for the Stories', description: 'Catch an Amazing legendary specimen.', flavor: 'For once, the old fishing story needs no exaggeration.', test: (s) => s.achievementProgress.amazingLegendaryCaught },
