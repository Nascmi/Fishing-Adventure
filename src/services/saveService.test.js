...
describe('save migrations and validation', () => {
  it('creates a complete version 17 new game', () => {
    const state = newGame()
  ...
  it('falls back safely for null and non-object input', () => {
    expect(validateSave(null).version).toBe(17)
    expect(validateSave('damaged').version).toBe(17)
  ...
  it('keeps a recovery copy when serialized storage is unreadable', () => {
    ...
    expect(loaded.game.version).toBe(17)
