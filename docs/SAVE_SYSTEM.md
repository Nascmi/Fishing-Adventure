...
Coin balances are never modified based on the runtime hostname or Android WebView origin. New games always begin with the configured 50 coins, including Capacitor builds served internally from `https://localhost`.
