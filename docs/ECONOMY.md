...
Evaluate the economy through playtesting rather than intuition alone. Track time to each rod, average value per catch, value per minute, rarity frequency, the share of income supplied by each rarity, specimen-preservation adoption, late-game coin balances, Trading Post purchase rates, and whether the 100-coin fee feels meaningful without discouraging display use.
