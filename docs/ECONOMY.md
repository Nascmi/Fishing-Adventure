...
The economy turns each catch into visible progress without turning fishing into work.

## Rules

- Common fish always have useful value.
...
Evaluate the economy through playtesting rather than intuition alone. Track time to each rod and specialty lure, average value per catch and per minute, quiet-cast frequency, rarity frequency, target-lure effectiveness, the share of income supplied by each rarity, specimen-preservation adoption, late-game coin balances, Trading Post purchase rates, and whether the 100-coin fee feels meaningful without discouraging display use.

Change one variable at a time and record the result in `BALANCE_NOTES.md`.
