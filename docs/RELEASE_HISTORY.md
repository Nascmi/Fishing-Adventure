...
Work completed after the initial prototype remains under `Unreleased` in `CHANGELOG.md` until a new version is deliberately cut.
...
- Added the initial mobile-first visual design.
