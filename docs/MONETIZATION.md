...
Monetization preparation is now part of the Android release path. It must support the game without changing the quality or pace of free play.
...
The store offers three honest, permanent contribution levels: Campfire Supporter at a tentative $0.99, Lakeside Supporter at $2.99, and Expedition Supporter at $4.99. Every level grants the exact same Community Supporter profile recognition. Higher levels exist only so a player may voluntarily contribute more; they grant no superior badge, exclusive cosmetic, currency, fishing benefit, content access, or social rank.
...
Premium cabin descriptions must correspond to functioning content. The Workshop uses the player's already-owned rods and included lure/tackle displays; the Coastal Shack includes dockside hanging decor and supports separately earned model boats. Purchasing either cabin does not grant rods, model boats, or progression rewards.

Two tentative $0.99 non-consumable packs provide two alternate hull finishes each: Midnight Blue and Heritage Red for the earned Great Lake Skiff, and Sunset Coral and Deep Ocean for the earned Gulf Coast Bay Skiff. The store disables each purchase until the corresponding boat has been earned through normal coin progression. Cosmetics never unlock a boat, area, discount, probability change, or performance benefit, and the original finish remains included permanently.
