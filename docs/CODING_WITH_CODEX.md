...
3. Summarize the outcome and important files.
4. Identify remaining placeholders or limitations.
5. Do not create a Git commit unless the user explicitly requests one.
